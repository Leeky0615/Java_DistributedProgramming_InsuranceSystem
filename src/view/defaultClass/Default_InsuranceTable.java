...
public class Default_InsuranceTable extends JTable{
	private static final long serialVersionUID = 1L;
	protected Vector<Vector<Object>> rowData;

	public Default_InsuranceTable() {
	...
	public Vector<Object> setHead(){
		...
		for (EInsuranceHead eInsuranceHead : EInsuranceHead.values()) {head.add(eInsuranceHead.getText());}
		return head;
	}
