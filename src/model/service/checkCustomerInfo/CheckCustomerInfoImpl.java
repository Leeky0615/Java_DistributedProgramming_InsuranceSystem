	...
	public void addNewCustomerInformation(Vector<String> customerContents){
		...
		for(ECustomer eCustomer : ECustomer.values()) {
			...
			case "병력":
				...
				case "혈압":customer.setIllHistory(EIllHistory.CANCER);break;
				case "당뇨":customer.setIllHistory(EIllHistory.CANCER);;break;
				case "사고":customer.setIllHistory(EIllHistory.CANCER);;break;
				default:break;
				}
				break;
